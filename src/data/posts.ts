...
export const posts = [
  {
    ...
    tags: [{ name: "Wooden" }, { name: "Seating" }, { name: "Single" }],
  },
  {
    id: "uuid2",
    author: "Erisson Jone",
